              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {availableMethods.includes('crypto') && (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-500">
                      {paymentOptions?.cryptoWallets.length} wallet(s) available
                    </div>
                  </button>
                )}
                ...
                {availableMethods.includes('bank') && (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-500">
                      {paymentOptions?.bankAccounts.length} account(s) available
                    </div>
                  </button>
                )}
                ...
                {availableMethods.includes('card') && (
                  ...
                  >
                    ...
                    <div className="text-sm text-gray-500">Manual processing</div>
                  </button>
                )}
              </div>
            </div>
